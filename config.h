...
#define BX_MAX_SMP_THREADS_SUPPORTED 12
...
#define BX_USE_QUICK_TLB_INVALIDATE 1
...
#define BX_SMP_QUANTUM_MIN  (1*4)
#define BX_SMP_QUANTUM_MAX (16*4)
...
#define BX_DBG_SUPPORT_VIR_BPOINT 0
#define BX_DBG_SUPPORT_LIN_BPOINT 0
#define BX_DBG_SUPPORT_PHY_BPOINT 0
...
#define BX_SupportHostAsmsFpu 1
