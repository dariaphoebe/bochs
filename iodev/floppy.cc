/////////////////////////////////////////////////////////////////////////
// $Id: floppy.cc,v 1.98.2.2 2006/04/30 18:14:03 vruppert Exp $
/////////////////////////////////////////////////////////////////////////
//
...
void bx_floppy_ctrl_c::init(void)
{
  ...
  BX_DEBUG(("Init $Id: floppy.cc,v 1.98.2.2 2006/04/30 18:14:03 vruppert Exp $"));
...
void bx_floppy_ctrl_c::register_state(void)
{
  ...
  for (i=0; i<10; i++) {
    sprintf(name, "%d", i);
    new bx_shadow_num_c(command, strdup(name), "", &BX_FD_THIS s.command[i], 16);
  }
  ...
  new bx_shadow_num_c(list, "pending_command", "", &BX_FD_THIS s.pending_command, 16);
  ...
  new bx_shadow_num_c(list, "format_fillbyte", "", &BX_FD_THIS s.format_fillbyte, 16);
  bx_list_c *result = new bx_list_c(list, "result", "", 10);
  for (i=0; i<10; i++) {
    sprintf(name, "%d", i);
    new bx_shadow_num_c(result, strdup(name), "", &BX_FD_THIS s.result[i], 16);
  }
  ...
  new bx_shadow_num_c(list, "DOR", "", &BX_FD_THIS s.DOR, 16);
  new bx_shadow_num_c(list, "TDR", "", &BX_FD_THIS s.TDR, 16);
  new bx_shadow_bool_c(list, "TC", "", &BX_FD_THIS s.TC);
  new bx_shadow_num_c(list, "main_status_reg", "", &BX_FD_THIS s.main_status_reg, 16);
  new bx_shadow_num_c(list, "status_reg0", "", &BX_FD_THIS s.status_reg0, 16);
  new bx_shadow_num_c(list, "status_reg1", "", &BX_FD_THIS s.status_reg1, 16);
  new bx_shadow_num_c(list, "status_reg2", "", &BX_FD_THIS s.status_reg2, 16);
  new bx_shadow_num_c(list, "status_reg3", "", &BX_FD_THIS s.status_reg3, 16);
  ...
  new bx_shadow_num_c(list, "SRT", "", &BX_FD_THIS s.SRT, 16);
  new bx_shadow_num_c(list, "HUT", "", &BX_FD_THIS s.HUT, 16);
  new bx_shadow_num_c(list, "HLT", "", &BX_FD_THIS s.HLT, 16);
  new bx_shadow_num_c(list, "config", "", &BX_FD_THIS s.config, 16);
  ...
  for (i=0; i<4; i++) {
    ...
    new bx_shadow_num_c(drive, "DIR", "", &BX_FD_THIS s.DIR[i], 16);
  }
}
#endif
