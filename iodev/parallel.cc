/////////////////////////////////////////////////////////////////////////
// $Id: parallel.cc,v 1.22.6.1 2003/03/28 09:26:07 slechta Exp $
/////////////////////////////////////////////////////////////////////////
//
...
{
  BX_DEBUG(("Init $Id: parallel.cc,v 1.22.6.1 2003/03/28 09:26:07 slechta Exp $"));
...
{
  BXRS_START(bx_parallel_c, this, "parallel port", list_p, 1);
  {
    BXRS_OBJ(bx_par_t, s);
  }
  BXRS_END;
