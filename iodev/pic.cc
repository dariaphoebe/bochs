/////////////////////////////////////////////////////////////////////////
// $Id: pic.cc,v 1.36.2.1 2004/11/05 00:56:47 slechta Exp $
/////////////////////////////////////////////////////////////////////////
//
...
void
bx_pic_c::register_state(sr_param_c *list_p)
{
  BXRS_START(bx_pic_c, BX_PIC_THIS_PTR, list_p, 20);
  {
...
void
bx_pic_t::register_state(sr_param_c *list_p)
{
  BXRS_START(bx_pic_t, this, list_p, 25);
  {
    ...
    BXRS_NUM_D (Bit8u  , edge_level,        "bitmap for irq mode (0=edge, 1=level)");
  }
  BXRS_END;
