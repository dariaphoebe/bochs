/////////////////////////////////////////////////////////////////////////
// $Id: keyboard.cc,v 1.89.2.1 2004/11/05 00:56:45 slechta Exp $
/////////////////////////////////////////////////////////////////////////
//
...
bx_keyb_c::init(void)
{
  BX_DEBUG(("Init $Id: keyboard.cc,v 1.89.2.1 2004/11/05 00:56:45 slechta Exp $"));
  Bit32u   i;
...
void
bx_keyb_c::register_state(sr_param_c* list_p)
{
  BXRS_START(bx_keyb_c, BX_KEY_THISP, list_p, 30);
  {
    ...
    BXRS_DARRAYP_D(pastebuf, pastebuf_len,
