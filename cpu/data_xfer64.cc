...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::MOV_GqEqM(bxInstruction_c *i)
{
  ...
  Bit64u val64 = read_virtual_qword_64(i->seg(), RMAddr(i));
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::MOV_EqIdM(bxInstruction_c *i)
{
  ...
  write_virtual_qword_64(i->seg(), RMAddr(i), op_64);
}
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::MOVZX_GqEbM(bxInstruction_c *i)
{
  ...
  Bit8u op2_8 = read_virtual_byte_64(i->seg(), RMAddr(i));
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::MOVZX_GqEwM(bxInstruction_c *i)
{
  ...
  Bit16u op2_16 = read_virtual_word_64(i->seg(), RMAddr(i));
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::MOVSX_GqEdM(bxInstruction_c *i)
{
  ...
  Bit32u op2_32 = read_virtual_dword_64(i->seg(), RMAddr(i));
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::CMOVO_GqEqM(bxInstruction_c *i)
{
  ...
  Bit64u op2_64 = read_virtual_qword_64(i->seg(), RMAddr(i));
